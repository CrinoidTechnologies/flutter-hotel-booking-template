...
class _RoomPopupViewState extends State<RoomPopupView> with TickerProviderStateMixin {
  ...
  Widget getRowView(String txt, String subtxt, int count, PopupTextType popupTextType) {
    return Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    subtxt,
                                    textAlign: TextAlign.left,
                                    style: TextStyle(fontWeight: FontWeight.w500, fontSize: 14, color: AppTheme.getTheme().disabledColor),
                                  ),
                                ],
                              ),
                            ),
